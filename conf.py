...
BLOG_TITLE = "Nicolas Fauchereau"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nicolasfauchereau.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://nicolasfauchereau.github.io/"
BLOG_EMAIL = "Nicolas.Fauchereau@gmail.com"
BLOG_DESCRIPTION = "Nicolas Fauchereau's personal website"  # (translatable)
...
#
# If you want to use Nikola with a non-supported clslanguage you have to provide
...
# WARNING: Some themes, including the default bootblog 4 theme,
...
POSTS = (
    ...
    ("posts/*.ipynb", "posts", "post.tmpl"), # new line
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
...
# this sets the blog section to be index (landing page)
# INDEX_PATH = "blog"
